...
NOTE: In this document we are using the words "community investment platform",
"crowd-funding site" and "marketplace" interchangeably.
...
include::features_requirements.adoc[]
